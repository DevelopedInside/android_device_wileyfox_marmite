...
#define LOG_TAG "ThermalHAL-8937"
#include <utils/Log.h>
...
static char *cpu_sensors_8937[] =
{
    ...
    "tsens_tz_sensor9", // CPU4
    "tsens_tz_sensor9", // CPU5
    "tsens_tz_sensor9", // CPU6
    "tsens_tz_sensor9", // CPU7
};
...
static struct target_therm_cfg sensor_cfg_8937[] = {
    {
        ...
        .mult = 0.1,
        .throt_thresh = 105, // qcom,freq-mitigation-temp
        .shutdwn_thresh = 115, // qcom,therm-reset-temp
    },
    {
...
ssize_t get_temperatures(thermal_module_t *module, temperature_t *list, size_t size) {
    ...
    if (!thermal_sens_size) {
        thermal_sens_size = thermal_zone_init(sensor_cfg_8937,
                                ARRAY_SIZE(sensor_cfg_8937));
